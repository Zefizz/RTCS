...
public class Server {
	...
	public void startServer() {
		...
		while (true) {
			...
			Thread handler = new Thread(new ServerHandler(received));
			handler.start();
		}
	}
	...
	public static void main(String[] args) {
		...
		//the server listens for incoming packets on port 69
		Server server = new Server();
		server.startServer();
		
		
		//input to shut down the server
		...
		//stop the server gracefully here kthnks
	}
}
